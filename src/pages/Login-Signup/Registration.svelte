      ...
      <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
        <div class="card-body">
          ...
          <div class="form-control">
            ...
            <input required type="email" placeholder="Enter your email address" class="peer input input-bordered" name="email" bind:value={customer_id}/>
          </div>
          ...
          <div class="form-control">
              ...
              <input required type="text" placeholder="Enter your address" class="input input-bordered" name="address" bind:value={address}/>
          </div>
          ...
          <div class="form-control">
            ...
            <select required class="select select-bordered w-full max-w-xs font-normal" bind:value={property_type}>
          ...
          <div class="form-control">
            ...
            <input required type="number" placeholder="Enter number of bedrooms" class="input input-bordered" name="bedrooms" min=0 bind:value={bedroom_num}/>
          </div>
          ...
          <div class="form-control">
            ...
            <input required type="text" placeholder="Enter 8 digit code" class="input input-bordered" name="evoucher" bind:value={EVC_code}/>
          </div>
